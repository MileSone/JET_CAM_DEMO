    ...
    function IncidentsViewModel() {
      ...
      self.buttonClick = function(data, event){
        //  self.clickedButton(event.currentTarget.id);
          var url = "FIF_CustomerAPI/incidents?title=" + self.value();
          console.log("url: ", url);
          mbe.logEvent("IncidentReport", {
              "allocatedTechnician":"joe_fif_technician",
              "reporter" :"jean_fif_admin",
              "modelNumber" :"dryer001",
              "priority":"high"
            });
      ...
      self.value = ko.observable("Dryer : The Dryer Is Getting Too Hot");
