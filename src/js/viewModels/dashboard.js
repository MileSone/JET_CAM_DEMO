...
,'ojs/ojpictochart', 'ojs/ojlegend'],
 function(oj, ko, $, app,mbe) {
    function dashboardViewModel() {
      ...
      self.janItems = ko.observableArray();
      self.febItems = ko.observableArray();
      self.marItems = ko.observableArray();
      self.aprilItems = ko.observableArray();
      ...
      var temp = [];
      var string = null;
      self.getPictoItems = function (month, monthIndex){
        var pictoItems = [];
      ...
      self.handleActivated = function(info) {
        self.isAdmin = mbe.isAdmin;


        console.log("handleActivated-isAdmin: ", self.isAdmin);
      //  console.log(self.hello);
        ...
        self.janItems(self.getPictoItems('January', 0));
        self.febItems(self.getPictoItems('February', 1));
        self.marItems(self.getPictoItems('March', 2));
        self.aprilItems(self.getPictoItems('April', 3));
        self.legendSections([{items: legendItems}]);
